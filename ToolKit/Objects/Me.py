...
#My Imports
from ToolKit.Objects import User

class Me(User):
    #Take in the user object and convert it to what we need
    def __init__(self, FLUserJSON):
        #Check if we even got a good chunk of data
        try:
            #Setup prior user class
            super().__init__(FLUserJSON)
        ...
        #If we didn't get one of these the JSON is bad and toss error
            ...
            raise ValueError("JSON given was incorrectly formatted and we couldn't build a Me Object out of it")
